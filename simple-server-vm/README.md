...
In real life project these should be automated somehow as well. Or I should investigate how the image could just ask from the environment the right access key.
