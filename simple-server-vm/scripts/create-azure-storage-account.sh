...
then
  ...
  echo "Example: ./create-azure-storage-account.sh westeurope kari-ss-vm-demo-terraform-storage-rg devkarissvmterrastorage dev-kari-ss-vm-terraform-container"
